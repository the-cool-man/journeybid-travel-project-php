          ...
          <div class="row">
			...
			<form method="post" enctype="multipart/form-data">
              ...
              <div class="panel panel-info">
                ...
                <div class="panel-body">
                  <div class="user-form col-md-8">
                    <div class="field-input">
                      <input type="text" value="<?php echo $decoded_meta['address']; ?>" class="input-text" name="address" placeholder="Address" required="required"> <span style="color:red;">*</span>
                    </div>
                    <div class="field-input">
                      <input type="text" value="<?php echo $decoded_meta['zipcode']; ?>" class="input-text" name="zipcode" placeholder="Zip Code" required="required"> <span style="color:red;">*</span>
                    </div>
                  </div>
                </div>
              </div>
			...
			<div class="panel panel-info">
                ...
                <div class="panel-body">
					<div class="user-form col-md-8">
						<div class="field-input">
						  <input type="text" value="<?php echo $decoded_meta['about_us']; ?>" class="input-text" name="about_us" placeholder="About me" required="required"> <span style="color:red;">*</span>
						</div>
					</div>
                </div>
            </div>
              ...
              <div class="panel panel-info">
                ...
                <div class="panel-body">
                  <div class="user-form col-md-8">
                    ...
                    <div class="field-input">
                      <input type="text" value="<?php echo $decoded_meta['mobile']; ?>" class="input-text" name="mobile" placeholder="Mobile" required="required"> <span style="color:red;">*</span>
                    </div>										
					<div class="field-input">      
						<input type="email" value="<?php echo $decoded_meta['hangout_id']; ?>" class="input-text" name="hangout_id" placeholder="Paypal ID" required="required"> <span style="color:red;">*</span>  </div>
                  </div>
                </div>
              </div>
              <?php if($_SESSION['values']['type'] == 'transport') { ?>
