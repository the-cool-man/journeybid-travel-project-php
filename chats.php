				...
				<form method="post">
                  <div class="message-wrap col-md-12">
                    ...
                    <div class="send-wrap ">
                      ...
                      <textarea class="form-control send-message" rows="3" placeholder="Write a reply..." name="chat_message" required></textarea>

                    </div>

                    <div class="btn-panel">
                    
                    <input type="submit" class="col-lg-4 text-right btn btn-primary   send-message-btn pull-right" name="sendmessage" value="Send Message">
