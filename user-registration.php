		  ...
		  <div class="col-md-6">
            <div class="red box">
              <div class="col-md-12">
                ...
                <h3> User Info</h3>
                <hr>
				<form method="post" autocomplete="off" action="#" id="commentForm">
                <div class="field-input">
                  <input type="text" class="input-text" value="" name="username" required id="cname" placeholder="Enter Your Full Name"/>
                </div>
				<div class="field-input">
                  <input type="email" class="input-text check_mail_existence" value="" name="email" required placeholder="Enter Your Email">
                ...
                <div class="field-input">
                  <div class="check-box">
                    <p for="checkbox"><input type="checkbox" id="checkbox" value="checked" name="checked" class="agreecheckedfld"> <span>I have read, understood & agree to the</span> <a href="terms-conditions.php"> Terms & Policies</a></p>
                  </div>
                 </div>
                <div class="field-input">
                  <input type="submit" name="submit" value="Sign Up" class="awe-btn awe-btn-1 awe-btn-medium signupdisabled" >
                  
                  <input type="reset" name="cancle" value="Cancel" class="awe-btn awe-btn-1 awe-btn-medium">
            ...
            <div class="green box">
              <div class="col-md-12">
                ...
                <div class="field-input">
				 ...
				 <div class="field-input">
                  <input type="email" class="input-text check_mail_existence" name="email" id="transemailvalidate" required placeholder="Enter Your Email">
				  <span class="error-1"></span>
                </div>
                <div class="field-input">
