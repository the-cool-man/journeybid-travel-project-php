          ...
          <div class="user-form user-signup">
            <div class="row">
              ...
              <div class="col-md-5 col-md-offset-2">
                ...
                <a class="btn btn-block btn-social btn-facebook" style="color:#fff;" href="auth.php?provider=Facebook"><i class="fa fa-facebook"></i> Sign in with Facebook</a>
				<a class="btn btn-block btn-social btn-twitter" style="color:#fff;" href="auth.php?provider=Twitter"><i class="fa fa-twitter"></i> Sign in with Twitter</a> 
