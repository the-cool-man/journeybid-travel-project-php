          ...
          <div class="tb">
            <div class="tb-cell">
              <ul class="menu-list text-uppercase">
                ...
                <?php } ?>
                <li> <a href="javascript:void(0)" title="" style="color:#233a7c;" data-toggle="modal" data-target="#myModal"><i class="fa fa-search"></i> Bids</a> </li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="carousel-inner">
      <div class="item slides active">
        <div class="slide-1">
          <div class="container">
            <div class="col-md-9">
              <h2 style="color:#fff; font-style:italic;text-shadow: 1px 1px 3px rgba(150, 150, 150, 1);"> Corporate & Club Buses <br>
                Weddings & Events </h2>
            </div>
            <div class="col-md-3">
    ...
    <div class="banner-cn">
      <div class="form-cn form-car">
        <form method="post" action="post-journey.php" id="search">
          <h2 style="color:#233a7c; font-weight:300;"> Post your trip needs for free bus company quotes </h2>
          ...
          <div class="carousel-inner">
            ...
            <div class="item active">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <p style="color:#fff;text-shadow: 1px 1px 1px rgba(1, 1, 1, 1);" class="testi"> "We used to call around to get the best deal, now... just one post." </p>
            ...
            <div class="item">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <p style="color:#fff;text-shadow: 1px 1px 1px rgba(1, 1, 1, 1);" class="testi"> "JourneyBid brings in the business, saves us money on marketing and ads." </p>
            ...
            <div class="item">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <p style="color:#fff;text-shadow: 1px 1px 1px rgba(1, 1, 1, 1);" class="testi">"Easiest coach trip! More options and cheaper than before."</p>
      ...
      <div class="title-wrap" style="background:none;">
        <div class="container">
          <div class="travel-title text-center">
            <h2 style="color:#233a7c; font-weight:300;" class="text-center"> JourneyBids online </h2>
          </div>
        </div>
      </div>
      <div class="cruise-list-cn tour-list-cn">
        ...
        <div class="cruise-item hvr-fade col-md-12">
          ...
          <div class="cruise-text">
            ...
            <small style="color:#747474;"> <i class="fa fa-calendar" style="color:#747474;"></i> Journey Created : <?php echo $result['created'];?></small> <small style="color:#747474;" class="pull-right"> <i class="fa fa-calendar" style="color:#747474;"></i> Journey Date : <?php echo date("jS M Y", strtotime($result['date']));?></small>
  ...
  <section class="confidence-subscribe">
    ...
    <div class="container">
      <div class="row cs-sb-cn">
        ...
        <?php if(isset($_POST['drop-us-line-form'])){
          ...
          <div class="subscribe">
            ...
            <div class="contact-cn1">
              ...
              <form method="post" action="">
                ...
                <div class="form-group">
                  <textarea class="field-input" rows="4" cols="54" id="message" name="dlmessage" required="required"></textarea>
                </div>
