        ...
        <div class="slide-1">
          <div class="container">
            <div class="col-md-10 col-md-offset-1" style="padding-left:40px;">
              ...
              Where bus and coach firms JourneyBid for your trips.</span> <br> <span style="font-size:18px;">Simply choose from the best offers nationwide.</span> 
      ...
      <div class="cruise-list-cn tour-list-cn">
        ...
        <div class="cruise-item hvr-fade col-md-12">
          ...
          <div class="cruise-text">
            ...
            <small style="color:#747474;"> <i class="fa fa-calendar" style="color:#747474;"></i> Journey Created : <?php echo $result['created'];?></small> <small style="color:#747474;" class="pull-right"> <i class="fa fa-calendar" style="color:#747474;"></i> Journey Date : <?php echo date("d/m/Y", strtotime($result['date']));?></small>
